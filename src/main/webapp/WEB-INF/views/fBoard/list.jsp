	...
	<div class="container">
		...
		<ul class="pagination justify-content-center">
			<c:if test="${pageMaker.hasPrev }">
				<li class="text-secondary" style="margin-right:5px"><a href="list?page=${pageMaker.startPageNo - 1 }">◀</a></li>
			</c:if>
			
			<c:forEach begin="${pageMaker.startPageNo }" end="${pageMaker.endPageNo }" 
				var="num">
				<li class="text-secondary" style="margin-right:5px"><a href="list?page=${num }&option=${option}&keyword=${keyword}">${num }</a></li>
			</c:forEach>
			
			<c:if test="${pageMaker.hasNext }">
				<li class="text-secondary" style="margin-right:5px"><a href="list?page=${pageMaker.endPageNo + 1 }">▶</a></li>
			</c:if>
		</ul>
	<hr>
